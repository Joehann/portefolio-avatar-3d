...
Command: npx gltfjsx@6.2.16 jujitsu.glb 
*/

import React, { useRef, useEffect } from "react"
import { useGLTF, useAnimations } from "@react-three/drei"

export default function Jujitsu(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF("/glb/jujitsu.glb")
...
useGLTF.preload("/glb/jujitsu.glb")

...
Command: npx gltfjsx@6.2.16 orchestra-conductor.glb 
*/

import React, { useRef, useEffect } from "react"
import { useGLTF, useAnimations } from "@react-three/drei"

export default function OrchestraConductor(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(
    "/glb/orchestra-conductor.glb"
  )
...
useGLTF.preload("/glb/orchestra-conductor.glb")
